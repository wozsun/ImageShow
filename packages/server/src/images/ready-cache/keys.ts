...
export const READY_IMAGE_LAST_UPDATED_KEY =
  `${READY_IMAGE_CACHE_PREFIX}last-updated`;
...
export const READY_IMAGE_DERIVED_REGISTRY_BYTES_KEY = `${READY_IMAGE_DERIVED_PREFIX}registry:bytes`;
