...
export async function ensureStorage() {
  ...
  await mkdir(join(env.TEMP_DIR, "upload"), { recursive: true });
  await mkdir(join(env.TEMP_DIR, "import"), { recursive: true });
...
export async function moveObject(fromPrefix: "objects" | "_uploads", fromKey: string, toPrefix: "objects" | "thumbs", toKey: string, targetContentType?: string, slug?: string) {
