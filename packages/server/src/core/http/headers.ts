...
export const spaDocumentHeaders: Readonly<Record<string, string>> = {
  ...
  "Content-Security-Policy":
    "script-src 'self'; worker-src 'self'; object-src 'none'; base-uri 'self'; frame-ancestors 'none'"
};
...
export const robotsCacheControl =
