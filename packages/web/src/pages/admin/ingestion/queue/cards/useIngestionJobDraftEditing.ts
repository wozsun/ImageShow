...
function isDeferredPlainField(field: ImageDraftDeferredField): field is DeferredPlainField {
  return field !== "theme" && field !== "author";
}

function isIngestionDraftUrlField(field: ImageDraftDeferredField): field is IngestionDraftUrlField {
...
export function useIngestionJobDraftEditing({
  ...
  const commit = useCallback(
    (field: ImageDraftDeferredField, value: string) => {
