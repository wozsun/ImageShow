...
function BackendCard({ backend, hasNonLocalBackend, busy, defaultStatus, defaultActionPending, onEdit, onSetDefault, onRemovalAction, onToggleEnabled, onRetryCleanup, onDragStart, onDragEnter, onDragEnd }: {
