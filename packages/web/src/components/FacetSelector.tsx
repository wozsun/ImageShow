...
// Searchable include/exclude multi-select over a facet (theme or tag). The value is
// a comma-joined list of slugs, each `!`-prefixed when excluding. Search results show
// slug + display name; selected chips show the display name (falling back to the slug);
// the emitted value always uses slugs. `noun` localizes the labels (主题 / 标签).
